  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "function_application_expression_list_comma_item": parse_function_application_expression_list_comma_item,
        "function_application_expression_list": parse_function_application_expression_list,
        "function_application": parse_function_application,
        ...
        "offsetable_accessor": parse_offsetable_accessor,
        "offsetable": parse_offsetable,
        "return_operator_right_pad": parse_return_operator_right_pad,
        "return_operator": parse_return_operator,
        ...
        "object_literal_entry_pair_valid_key": parse_object_literal_entry_pair_valid_key,
        "object_literal_entry_pair": parse_object_literal_entry_pair,
        "object_literal": parse_object_literal,
        "function_comma_arg": parse_function_comma_arg,
        "function_list_args": parse_function_list_args,
        ...
        "property_name": parse_property_name,
      ...
      function parse_statement() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            result0 = parse_return_operator_right_pad();
          }
        }
        return result0;
      }
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 === null) {
                result0 = parse_function_application();
                if (result0 === null) {
                  result0 = parse_id();
                }
              }
      ...
      function parse_function_application_expression_list_comma_item() {
      ...
      function parse_function_application_expression_list() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = [];
            result3 = parse_function_application_expression_list_comma_item();
            while (result3 !== null) {
      ...
      function parse_function_application() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = parse_function_application_expression_list();
        ...
        if (result0 !== null) {
          result0 = (function(offset, f, a) { return { tag: "fun_app", fun:f, args:a }})(pos0, result0[0], result0[3]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_offsetable_accessor() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, o) { return { tag: "offsetable_accessor_as_arr", offset:o }; })(pos0, result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, o) { return { tag: "offsetable_accessor_as_obj", offset:o }; })(pos0, result0[2]);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_offsetable() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result3 = parse_offsetable_accessor();
            if (result3 !== null) {
              result2 = [];
              while (result3 !== null) {
                result2.push(result3);
        ...
        if (result0 !== null) {
          result0 = (function(offset, container, offset) { return { tag: "offsetable", id:container, offset:offset} })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_return_operator_right_pad() {
        var result0, result1;
        var pos0, pos1;
        
        pos0 = pos;
        pos1 = pos;
        result0 = parse_return_operator();
        if (result0 !== null) {
          result1 = parse_right_pad();
          if (result1 !== null) {
            result0 = [result0, result1];
        ...
        if (result0 !== null) {
          result0 = (function(offset, r) { return r; })(pos0, result0[0]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_return_operator() {
        var result0, result1, result2;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, e) { return { tag:"return", value:e}; })(pos0, result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_comparative() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, left, op, right) { return { tag:"infix", operator:op, left:left, right:right } })(pos0, result0[0], result0[2], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_object_literal_entry_pair_valid_key() {
        var result0;
      ...
      function parse_object_literal_entry_pair() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_object_literal_entry_pair_valid_key();
        if (result0 !== null) {
          result1 = [];
          result2 = parse_ws_nl();
          while (result2 !== null) {
      ...
      function parse_function_comma_arg() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
      ...
      function parse_function_list_args() {
        var result0, result1, result2;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result1 = [];
          result2 = parse_function_comma_arg();
          while (result2 !== null) {
            result1.push(result2);
            result2 = parse_function_comma_arg();
          }
        ...
        if (result0 !== null) {
          result0 = (function(offset, h, t) { return [h].concat(t) })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_function_literal() {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  result5 = parse_function_list_args();
                  if (result5 !== null) {
                    if (input.substr(pos, 2) === "){") {
                      result6 = "){";
                      pos += 2;
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, a, body) { return { tag: "function_literal", name:name, args:a, body:body } })(pos0, result0[2], result0[5], result0[8]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_number_literal() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, left, right) { return { tag:"number_literal", value:new Number(left.join('') + '.' + right.join(''))}; })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, integer) { return { tag:"number_literal", value:new Number(integer.join(''))}; })(pos0, result0);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_var_name() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, h, t) { return { tag:"iddeclr", name:h + t.join('')}})(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_property_name() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, h, t) { return { tag:"property_name", name:h + t.join('')}})(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
